...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Мар 14 2021 г., 20:38
...
INSERT INTO `tor_cards` (`id`, `title`, `text`, `img`, `alt`, `section_number`) VALUES
(1, 'KBE', 'Профили, поставляемые на украинский рынок, производятся по уникальной без свинцовой технологии greenline, безопасной для здоровья человека и окружающей среды.', 'img/profile_manufacturers/kbe.png', 'KBE', 1),
(2, 'Koemmerling', 'KÖMMERLING - философия, основанная на партнерстве. Более пятидесяти лет на рынке, представляет большой ассортимент окон и средств визуальной защиты.', 'img/profile_manufacturers/koemmerling.png', 'Koemmerling', 1),
(3, 'Salamander', 'Оригинальная немецкая профильная система Salamander. Придумана в Германии, сделана в Германии, гарантия немецкого качества и надёжности.', 'img/profile_manufacturers/salamander.png', 'Salamander', 1),
(4, 'Rehau', 'Инновационные решения на основе полимеров в оконных и дверных системах, предотвращают теплопотери, придают комфорта и безопасности премиум-класса.', 'img/profile_manufacturers/rehau.svg', 'Rehau', 1),
(5, 'WDS', 'Оконный профиль WDS экструдируют на заводе «МИРОПЛАСТ», прочный с низкой теплопроводностью, защищен от воздействия ультрафиолетового излучения .', 'img/profile_manufacturers/wds.svg', 'WDS', 1),
(6, 'Schueco', 'Продукция Schüco из алюминия, ПВХ и стали отвечает самым высоким стандартам с точки зрения дизайна, комфорта, безопасности и энергоэффективности.', 'img/profile_manufacturers/schueco-logo.svg', 'Schueco', 1),
(7, 'Reynaers', 'Reynaers Aluminium - современные, надежные решения из алюминия для окон, дверей, раздвижных дверей, фасадов, веранд, оранжерей и систем солнцезащиты.', 'img/profile_manufacturers/reynaers.png', 'Reynaers', 1),
(8, 'Alutech', 'АЛЮТЕХ международная компания, специализируется на изготовлении секционных автоматических ворот, роллетных и алюминиевых профильных систем.', 'img/profile_manufacturers/alutech.png', 'Alutech', 1),
(9, 'Aluplast', 'Концерн в городе Эттлинген. Для aluplast – качество найвысший приоритет, акцент на котором прослеживается во всех процессах, системах, продуктах, инновациях и услугах.', 'img/profile_manufacturers/aluplast.svg', 'Aluplast', 1);
