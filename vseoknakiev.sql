...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Мар 13 2021 г., 10:58
...
--
-- Структура таблицы `tor_section_main`
--

CREATE TABLE `tor_section_main` (
  `id` int(11) NOT NULL,
...
--
-- Дамп данных таблицы `tor_section_main`
--

INSERT INTO `tor_section_main` (`id`, `title`, `slogan`, `button_name`, `text`) VALUES
...
--
-- Индексы таблицы `tor_section_main`
--
ALTER TABLE `tor_section_main`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT для таблицы `tor_section_main`
--
ALTER TABLE `tor_section_main`
