...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Мар 15 2021 г., 16:20
...
--
-- База данных: `vseoknakiev`
--

-- --------------------------------------------------------

--
-- Структура таблицы `tor_articles`
--

CREATE TABLE `tor_articles` (
...
--
-- Дамп данных таблицы `tor_articles`
--

INSERT INTO `tor_articles` (`id`, `title`, `img`, `intro`, `full`, `section_id`, `cat_id`, `date`, `meta_desc`, `meta_key`) VALUES
...
--
-- Структура таблицы `tor_cards`
--

CREATE TABLE `tor_cards` (
  `id` int(11) NOT NULL,
...
--
-- Дамп данных таблицы `tor_cards`
--

INSERT INTO `tor_cards` (`id`, `title`, `text`, `img`, `alt`, `css_class`, `section_number`) VALUES
(1, 'KBE', 'Профили, поставляемые на украинский рынок, производятся по уникальной без свинцовой технологии greenline, безопасной для здоровья человека и окружающей среды.', 'img/profile_manufacturers/kbe.png', 'KBE', 'brаnds', 1),
(2, 'Koemmerling', 'KÖMMERLING - философия, основанная на партнерстве. Более пятидесяти лет на рынке, представляет большой ассортимент окон и средств визуальной защиты.', 'img/profile_manufacturers/koemmerling.png', 'Koemmerling', 'brаnds', 1),
(3, 'Salamander', 'Оригинальная немецкая профильная система Salamander. Придумана в Германии, сделана в Германии, гарантия немецкого качества и надёжности.', 'img/profile_manufacturers/salamander.png', 'Salamander', 'brаnds', 1),
(4, 'Rehau', 'Инновационные решения на основе полимеров в оконных и дверных системах, предотвращают теплопотери, придают комфорта и безопасности премиум-класса.', 'img/profile_manufacturers/rehau.svg', 'Rehau', 'brаnds svg', 1),
(5, 'WDS', 'Оконный профиль WDS экструдируют на заводе «МИРОПЛАСТ», прочный с низкой теплопроводностью, защищен от воздействия ультрафиолетового излучения .', 'img/profile_manufacturers/wds.svg', 'WDS', 'brаnds svg', 1),
(6, 'Schueco', 'Продукция Schüco из алюминия, ПВХ и стали отвечает самым высоким стандартам с точки зрения дизайна, комфорта, безопасности и энергоэффективности.', 'img/profile_manufacturers/schueco-logo.svg', 'Schueco', 'brаnds svg', 1),
(7, 'Reynaers', 'Reynaers Aluminium - современные, надежные решения из алюминия для окон, дверей, раздвижных дверей, фасадов, веранд, оранжерей и систем солнцезащиты.', 'img/profile_manufacturers/reynaers.png', 'Reynaers', 'brаnds_min png_little', 1),
(8, 'Alutech', 'АЛЮТЕХ международная компания, специализируется на изготовлении секционных автоматических ворот, роллетных и алюминиевых профильных систем.', 'img/profile_manufacturers/alutech.png', 'Alutech', 'brаnds', 1),
(9, 'Aluplast', 'Концерн в городе Эттлинген. Для aluplast – качество найвысший приоритет, акцент на котором прослеживается во всех процессах, системах, продуктах, инновациях и услугах.', 'img/profile_manufacturers/aluplast.svg', 'Aluplast', 'brаnds_middle svg_big', 1),
(10, 'Металлопластиковые окна, двери', '', 'img/products/window_2.png', 'windows', '', 2),
(11, 'Алюминиевые системы', '', 'img/products/balconies_2.png', 'balconies', '', 2),
(12, 'Гаражные ворота, рольставни', '', 'img/products/garage_roller_blinds.png', 'garage roller blinds', '', 2),
(13, 'Двери', '', 'img/products/doors.png', 'doors', '', 2),
(14, 'Раздвижные системы', '', 'img/products/sliding_systems.png', 'sliding systems', '', 2),
(15, 'Остекление беседок', '', 'img/products/gazebos.png', 'gazebos', '', 2);

-- --------------------------------------------------------

--
-- Структура таблицы `tor_categories`
--

CREATE TABLE `tor_categories` (
  `id` int(10) UNSIGNED NOT NULL,
  `title` varchar(100) NOT NULL,
  `img` varchar(255) NOT NULL,
...
--
-- Дамп данных таблицы `tor_categories`
--

INSERT INTO `tor_categories` (`id`, `title`, `img`, `section_id`, `description`, `meta_desc`, `meta_key`) VALUES
...
--
-- Структура таблицы `tor_comments`
--

CREATE TABLE `tor_comments` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Дамп данных таблицы `tor_comments`
--

INSERT INTO `tor_comments` (`id`, `article_id`, `user_id`, `parent_id`, `text`, `date`) VALUES
...
--
-- Структура таблицы `tor_courses`
--

CREATE TABLE `tor_courses` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Дамп данных таблицы `tor_courses`
--

INSERT INTO `tor_courses` (`id`, `type`, `header`, `sub_header`, `img`, `link`, `text`, `did`, `latest`, `section_ids`) VALUES
...
--
-- Структура таблицы `tor_menu`
--

CREATE TABLE `tor_menu` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Дамп данных таблицы `tor_menu`
--

INSERT INTO `tor_menu` (`id`, `type`, `title`, `text`, `link`, `parent_id`, `external`) VALUES
(1, 2, 'Главная', NULL, '/', NULL, 0),
(2, 3, 'fa fa-mobile', ' (067)408-16-14', '/contact.html', NULL, 0),
(3, 3, 'fas fa-phone', ' (044)232-90-20', '/contact.html', NULL, 0),
(4, 3, 'fas fa-lightbulb', NULL, '/idea.html', 0, 0),
(5, 3, 'fas fa-car-side', NULL, '/delivery.html', 0, 0),
(6, 3, 'fas fa-book', NULL, '/news.html', 0, 0),
(8, 2, 'Отдел продаж', NULL, '/sales.html', NULL, 0),
(9, 1, 'Продукция', NULL, '/product.html', NULL, 0),
(10, 1, 'Профиль', NULL, '/profile.html', 9, 0);

-- --------------------------------------------------------

--
-- Структура таблицы `tor_polls`
--

CREATE TABLE `tor_polls` (
  `id` int(10) UNSIGNED NOT NULL,
  `title` varchar(100) NOT NULL,
...
--
-- Дамп данных таблицы `tor_polls`
--

INSERT INTO `tor_polls` (`id`, `title`, `state`) VALUES
...
--
-- Структура таблицы `tor_poll_data`
--

CREATE TABLE `tor_poll_data` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Дамп данных таблицы `tor_poll_data`
--

INSERT INTO `tor_poll_data` (`id`, `poll_id`, `title`) VALUES
(1, 1, 'HTML'),
(2, 1, 'CSS'),
(3, 1, 'JavaScript'),
(4, 1, 'PHP'),
...
--
-- Структура таблицы `tor_poll_voters`
--

CREATE TABLE `tor_poll_voters` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Дамп данных таблицы `tor_poll_voters`
--

INSERT INTO `tor_poll_voters` (`id`, `poll_data_id`, `ip`, `date`) VALUES
(1, 11, 2130706433, 1399838478);

-- --------------------------------------------------------

--
-- Структура таблицы `tor_quotes`
--

CREATE TABLE `tor_quotes` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Дамп данных таблицы `tor_quotes`
--

INSERT INTO `tor_quotes` (`id`, `author`, `text`) VALUES
...
--
-- Структура таблицы `tor_sections`
--

CREATE TABLE `tor_sections` (
  `id` int(10) UNSIGNED NOT NULL,
  `title` varchar(100) NOT NULL,
  `img` varchar(255) NOT NULL,
  `description` text NOT NULL,
...
--
-- Дамп данных таблицы `tor_sections`
--

INSERT INTO `tor_sections` (`id`, `title`, `img`, `description`, `meta_desc`, `meta_key`) VALUES
...
--
-- Структура таблицы `tor_section_components`
--

CREATE TABLE `tor_section_components` (
  `id` int(11) NOT NULL,
  `title` varchar(255) NOT NULL,
...
--
-- Дамп данных таблицы `tor_section_components`
--

INSERT INTO `tor_section_components` (`id`, `title`, `slogan`, `button_name`, `text`) VALUES
(1, 'vseokna. kiev.ua', 'Лучшее для Вас', 'Информация', 'Здесь рассказывается о компании'),
(2, 'Лучшие производители металлопластикового профиля', '', '', 'Мы подобрали для Вас самых лучших производителей представленных на украинском рынке профильных систем для металлопластиковых окон.'),
(3, 'Виды изделий', '', '', '');

-- --------------------------------------------------------

--
-- Структура таблицы `tor_sef`
--

CREATE TABLE `tor_sef` (
  `id` int(10) UNSIGNED NOT NULL,
  `link` varchar(255) NOT NULL,
...
--
-- Дамп данных таблицы `tor_sef`
--

INSERT INTO `tor_sef` (`id`, `link`, `alias`) VALUES
(1, '/poll', 'poll'),
(2, '/register', 'register'),
(3, '/activate', 'activate'),
...
--
-- Структура таблицы `tor_users`
--

CREATE TABLE `tor_users` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Индексы таблицы `tor_articles`
--
ALTER TABLE `tor_articles`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `tor_cards`
--
ALTER TABLE `tor_cards`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `tor_categories`
--
ALTER TABLE `tor_categories`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `tor_comments`
--
ALTER TABLE `tor_comments`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `tor_courses`
--
ALTER TABLE `tor_courses`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `tor_menu`
--
ALTER TABLE `tor_menu`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `tor_polls`
--
ALTER TABLE `tor_polls`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `tor_poll_voters`
--
ALTER TABLE `tor_poll_voters`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `tor_quotes`
--
ALTER TABLE `tor_quotes`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `tor_sections`
--
ALTER TABLE `tor_sections`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `tor_section_components`
--
ALTER TABLE `tor_section_components`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `tor_sef`
--
ALTER TABLE `tor_sef`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `tor_users`
--
ALTER TABLE `tor_users`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT для таблицы `tor_articles`
--
ALTER TABLE `tor_articles`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT для таблицы `tor_cards`
--
ALTER TABLE `tor_cards`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT для таблицы `tor_categories`
--
ALTER TABLE `tor_categories`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT для таблицы `tor_comments`
--
ALTER TABLE `tor_comments`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT для таблицы `tor_courses`
--
ALTER TABLE `tor_courses`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT для таблицы `tor_menu`
--
ALTER TABLE `tor_menu`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT для таблицы `tor_polls`
--
ALTER TABLE `tor_polls`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT для таблицы `tor_poll_voters`
--
ALTER TABLE `tor_poll_voters`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT для таблицы `tor_quotes`
--
ALTER TABLE `tor_quotes`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT для таблицы `tor_sections`
--
ALTER TABLE `tor_sections`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT для таблицы `tor_section_components`
--
ALTER TABLE `tor_section_components`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT для таблицы `tor_sef`
--
ALTER TABLE `tor_sef`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT для таблицы `tor_users`
--
ALTER TABLE `tor_users`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
COMMIT;
